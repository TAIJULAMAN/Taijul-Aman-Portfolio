const Skills = () => {
  ...
  return (
    <div className="px-[20px] md:px-[120px] lg:px-[120px] flex flex-col  justify-start md:justify-center text-start md:items-center py-10 z-1 relative bg-[#2f424d] text-ellipsis box-content line-clamp-2">
      <div className="relative flex flex-col w-full mx-w-[1100px] justify-start md:justify-between items-center md:items-center gap-3">
